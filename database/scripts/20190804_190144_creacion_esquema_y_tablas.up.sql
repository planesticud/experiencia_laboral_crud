...
CREATE TABLE experiencia_laboral.dato_adicional_experiencia_laboral (
	id serial NOT NULL,
	tipo_dato_adicional_id integer NOT NULL,
	experiencia_laboral_id integer NOT NULL,
...
-- ddl-end --
COMMENT ON COLUMN experiencia_laboral.dato_adicional_experiencia_laboral.tipo_dato_adicional_id IS 'Tipo de dato adicional para la experiencia laboral, referencia a la tabla tipo_dato_adicional del core';
-- ddl-end --
...
CREATE TABLE experiencia_laboral.experiencia_laboral (
	...
	tipo_dedicacion_id integer NOT NULL,
...
-- ddl-end --
COMMENT ON COLUMN experiencia_laboral.experiencia_laboral.persona_id IS 'Referencia a la tabla ente';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN experiencia_laboral.experiencia_laboral.organizacion_id IS 'Referencia a la tabla organizacion del core';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN experiencia_laboral.soporte_experiencia_laboral.documento_id IS 'Referencia a la tabla documento del microservicio de documentos';
-- ddl-end --
...
ALTER TABLE experiencia_laboral.experiencia_laboral ADD CONSTRAINT fk_experiencia_laboral_tipo_vinculacion FOREIGN KEY (tipo_vinculacion_id)
...
ALTER TABLE experiencia_laboral.experiencia_laboral ADD CONSTRAINT fk_experiencia_laboral_cargo FOREIGN KEY (cargo_id)
...
ALTER TABLE experiencia_laboral.dato_adicional_experiencia_laboral ADD CONSTRAINT fk_dato_adicional_experiencia_laboral_experiencia_laboral FOREIGN KEY (experiencia_laboral_id)
...
ALTER TABLE experiencia_laboral.soporte_experiencia_laboral ADD CONSTRAINT fk_soporte_experiencia_laboral_experiencia_laboral FOREIGN KEY (experiencia_laboral_id)
REFERENCES experiencia_laboral.experiencia_laboral (id) MATCH FULL
ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE experiencia_laboral.experiencia_laboral ADD CONSTRAINT fk_experiencia_laboral_tipo_dedicacion FOREIGN KEY (tipo_dedicacion_id)
